...
public final class DateTimeTools
{
    ...
    {
        MyTools.h1("to prevent never used warnings");
        System.out.println(getCurrentDate());
        System.out.println(getCurrentTime());
        System.out.println(getCurrentTimestamp());
        System.out.println(makeRandomDateOfBirth(30));
        System.out.println(makeRandomDate());
        System.out.println(makeRandomTime());
        System.out.println(makeRandomTimestamp());
        System.out.println(makeTime(12, 30, 0));
        System.out.println(makeTimestamp(2021, 2, 7));
        System.out.println(makeRandomTimestamp(2020));
    }

    /**
     * The constructor is private so that
     * <code>DateTimeTools</code> can't be be instantiated.
     */
