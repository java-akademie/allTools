...
/**
 * The final class <code>TestDatenTools</code> has some useful
...
{
    private static final String[] firstNameFemale = {"brigita", "frieda", "adele", "beate", "elisabeth", "linda",
            "karin", "heidi", "maria", "ute", "martina", "margarete", "ludowika", "marianne", "susanne", "gerlinde",
            "gabriele", "eva", "ullrike"};

    private static final String[] firstNameMale = {"fritz", "urs", "oli", "albert", "mario", "hans-peter", "heinz",
            "peter", "max", "oliver", "josef", "johann", "friedrich", "georg", "gerhard", "robert", "johannes",
            "bruno","moritz"};

    private static final String[] lastName = {"mueller", "schuster", "meier", "allmen", "von arx", "friedrichs", "mauler",
            "gruber", "bamberger", "holterer", "german", "lugner", "strache", "havlik", "nigl", "meier", "maier",
            "strobl", "huber", "einstein", "vogel", "fink", "sperling"};

    private static final String[] city = {"basel", "genf", "zuerich", "wien", "berlin", "paris", "brugg", "bruck",
            "wiel", "graz", "klagenfurt", "krems", "muenchen", "koeln", "berlin"};

    private static final String[] street = {"hauptstrasse", "hauptplatz", "gablenzgasse", "lehenmattstrasse",
    ...
    {
        return getPlz() + " " + getCity() + " " + getStreet() + " " + " " + getNumberOfHouse();
    }
    ...
    {
        int age = DateTimeTools.getRandomAge(peakAge);
        int year = DateTimeTools.getYearOfBirth(age);
        return DateTimeTools.makeRandomDate(year);
    }
}
